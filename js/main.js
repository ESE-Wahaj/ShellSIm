...
jQuery(document).ready(function ($) {
  ...
  var o = {
    ...
    Pictures: "4",
    Videos: "5",
  }; //Object to assign array of sub folders to a folder
  ...
  $("body").terminal(
    {
      ...
      echo: function (arg1) {
        ...
        this.echo(arg1 + "\n");
        this.echo(
          "> The [[b;#ff3300;]echo] command prints back your arguments."
        );
        this.echo(
          "> Type [[b;#ff3300;]help] and check your first task is completed."
        );
      ...
      pwd: function () {
        ...
        this.echo(
          "> Now type [[b;#ff3300;]ls] to see the directories and files present in the current directory"
        );
      },
      ls: function () {
        arr[2] = 1;
        ...
        x = 0;
        this.echo(
          "> The [[b;#ff3300;]ls] command will list directories and files in the current directory by default,\n" +
            "however you can specify which path you want to list the directories of."
        );
        this.echo(
          "> Now type [[b;#ff3300;]cd Documents] to enter a sub directory."
        );
      },
      cd: function (arg1) {
        x = o[pwdv[pwdv.length - 1]];
        ...
        if (e == 1) {
          ...
          pwdv.push(arg1);
          this.echo(
            "> [[b;#ff3300;]cd] stands for Change Directory. You just changed your directory."
          );
          this.echo(
            "> You can check your present directory by typing [[b;#ff3300;]pwd]."
          );
          this.echo(
            "> To return back to the [[b;#44D544;]previous directory] you should type [[b;#ff3300;]cd ..]."
          );
          this.echo(
            "> To return back to the [[b;#44D544;]home] directory you should type [[b;#ff3300;]cd ~]."
          );
          pwdv.splice(0, 1);
          var pwdvNew = pwdv.join(",").replace(/,/g, "/").split();
          ...
          if (x != 0) {
            ...
            pwdv.unshift("lterm");
            this.echo(
              ">You have returned to the [[b;#44D544;]parent directory]\n"
            );
            this.echo(
              ">Now type [[b;#ff3300;]help] to see the commands not completed and try them."
            );
          } else {
            x = 0;
      ...
      cat: function (arg1) {
        ...
        y = "";
        this.echo(
          "> The [[b;#ff3300;]cat] command views the text inside a file on the terminal."
        );
      },
      touch: function (arg1) {
        this.echo(
          "> [[b;#ff3300;]touch] allows you to the create new empty files. Type [[b;#ff3300;]ls] to see the new file created."
        );
        arr[7] = 1;
        x = o[pwdv[pwdv.length - 1]];
        f[x].push(arg1);
      ...
      cp: function (arg1, arg2) {
        this.echo(
          "> The [[b;#ff3300;]cp] command copies your file to the given location."
        );
      ...
      rm: function (arg1) {
        ...
        this.echo(
          "> Type [[b;#ff3300;]ls] to see the remaining files and directories in the current directory."
        );
        x = o[pwdv[pwdv.length - 1]];
        for (i = 0; i <= s[x].length; i++) {
          if (arg1 == s[x][i]) {
      ...
      mkdir: function (arg1) {
        arr[10] = 1;
        this.echo(
          "> The [[b;#ff3300;]mkdir] command (Make Directory) creates a directory if it doesn’t already exist."
        );
      ...
      Clear: function () {
        ...
        this.push(function (cmd, term) {
          if (cmd == "clear" || cmd == "Clear") {
            //Changed here
            arr[11] = 1;
          } else this.echo("[[b;#ff3300;]Wrong step commands. Type the exact commands requested.]\n");
        });
      },
      uname: function () {
        arr[12] = 1;
        this.echo("lterm\n");
        this.echo(
          "> [[b;#ff3300;]uname] find out the name of the unix/Linux system we are using.\n" +
            "\n> Print system information \n" +
            "\n> With no " +
            "option used it is same as -s\n"
        );
        this.echo(
          "> Type [[b;#ff3300;]help] and check that this task is completed.\n"
        );
      },
      date: function () {
        arr[13] = 1;
      ...
      ifconfig: function () {
        ...
        this.echo(
          "> Relax. It's perfectly fine if your don't understand any of this right now. This is just a demonstration."
        );
        this.echo(
          "> The [[b;#ff3300;]ifconfig] command displays information about currently active network interfaces."
        );
        this.echo(
          "> So, basically, it gives you a lot of information about your network."
        );
        this.echo(
          '> e.g. your local ip address for wireless (here, wlan0) or ethernet (here, eth0) can be found in their respective "inet addr:" fields.'
        );
        this.echo(
          "> It can also be used to configure the iterfaces but we will not discuss it here."
        );
        this.echo(
          "> Type [[b;#ff3300;]help] and check that this task is completed."
        );
      ...
      tty: function () {
        ...
        this.echo("/dev/lterm\n");
        this.echo(
          "> [[b;#ff3300;]tty] is used to print the file name of the terminal connected to standard input (keyboard)\n"
        );
        this.echo(
          "> Type [[b;#ff3300;]help] and check that this task is completed.\n"
        );
      ...
      history: function () {
        var i;
        this.echo(
          "> [[b;#ff3300;]history] This command is used to print the commands which are used in the previous iterations\n"
        );
        this.echo(
          "> Type [[b;#ff3300;]help] and check that this task is completed.\n"
        );
      ...
      about: function () {
        this.echo(
          "> Hey [[b;#44D544;]netizen], welcome to my [[b;#ff3300;]Terminal Emulator]. I hope you have fun learning the [[b;#44D544;]bash] commands.\n"
        );
        this.echo("> We're [[b;#44D544;]Junaid Malik and Wahaj Naveed]");
      },
    },
    {
      // DANGER: high
